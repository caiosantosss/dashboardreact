...
const Sidebar = () => {
  ...
  const activeLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white-600 text-md m-2'
    ...
    <div className='ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10'>
      { activeMenu && (<>
        <div className='flex justify-between items-center'>
          ...
          className='items-center gap-3 ml-3 mt-4 flex text-lx font-extrabold tracking-tight dark:text-white text-slate-900'>
